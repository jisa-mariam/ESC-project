...
function testGeneralAllocationDrawn(myDoc){
    ...
    $.writeln(arrayCapstone.toSource());
    if(arrayCapstone[0]["assigned"] === true){
        var projectNumber = 1;
        var strInput = "Project" + projectNumber.toString() + " is assigned";
        var win = new Window("dialog", 'Box drawn');
        win.add("statictext", undefined, strInput);
        win.add("statictext", undefined, "Test 1 passed, project has been assigned successfully");
        win.show();
        }
    
    if(arrayCapstone[1]["assigned"] === false){
        var projectNumber = i+1;
        var strInput = "Project" + projectNumber.toString() + " is not assigned";
        var win = new Window("dialog", 'Box not drawn');
        win.add("statictext", undefined, strInput);
        win.add("statictext", undefined, "Test 2 passed, project larger than boundary was not assigned");
        win.show();
        }
